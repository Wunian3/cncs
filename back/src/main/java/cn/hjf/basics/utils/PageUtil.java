...
public class PageUtil {
    ...
    public static Pageable initPage(PageVo page){
        ...
        if(!HjfNullUtils.isNull(sort)) {
            Sort.Direction direction = HjfNullUtils.isNull(order) ? Sort.Direction.DESC : Sort.Direction.valueOf(order.toUpperCase());
    ...
    public static String camel2Underline(String underlineContent) {
        if (HjfNullUtils.isNull(underlineContent)) {
            return NULL_STR;
        }
